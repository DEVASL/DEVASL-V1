...
return {
  description = 'Anti bot create by MAHDI ALBADRY',
  usage = {
...
--By @MAHDI ALBADRY
--https://github.com/DEVASL/DEVASL-V1/plugins/lock_bot.lua
---Modified by @MAHDI ALBADRY for lock add bot , unlock add bots