...
local function run(msg,matches)
    if matches[1] == "chat_add_user"  then 
     local text = ' 🎀➖🎗 @DEVASL اهلا و سـهلا بـك عـزيزي ❤️يـرجـي متـابعه قـناه السـورس '..'\n'..'\n'
    ...
    ..'🎀🎗الـوقـت🎖 : '..os.date(' %T*', os.time())..'\n'  
      ...
      if matches[1] == "chat_del_user" then
       return "  @DEVASL 🎀🎖  حبـيـب كـلبـي الله ويـاك➖ خلصت من عضـو الف حمداللـه الباقي تابـعو"..msg.action.user.first_name
end
end
